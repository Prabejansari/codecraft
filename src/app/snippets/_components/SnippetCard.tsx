  ...
  return (
    ...
    >
      <div className="relative">
        <Navigate href={`/snippets/${snippet._id}`} className="z-10">
          <div
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex mt-2 items-center gap-1 text-xs text-gray-500">
                      <Clock className="size-3" />
                      {mounted ? new Date(snippet._creationTime).toLocaleDateString() : ''}
                    </div>
                  </div>
                </div>
              </div>
